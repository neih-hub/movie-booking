  ...
  <div class="row">
    ...
    <div class="col-md-3 text-center">
      ...
      <div class="position-relative d-inline-block">
        <img src="{{ $user->avatar ? asset($user->avatar) : '/images/default-avatar.png' }}" class="rounded-circle"
          width="140" height="140" style="object-fit: cover; border: 4px solid #ddd;">

        <form action="{{ route('profile.avatar') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <label class="btn btn-sm btn-light shadow position-absolute" style="bottom: 0; right: 0; border-radius: 50%;">
    ...
    <div class="col-md-9">
      ...
      <ul class="nav nav-tabs mb-4">
        ...
        <li class="nav-item">
          <button class="nav-link" data-bs-toggle="tab" data-bs-target="#notifications">Thông báo</button>
        </li>

        <li class="nav-item">
          <button class="nav-link" data-bs-toggle="tab" data-bs-target="#history">Lịch sử giao dịch</button>
        </li>

        <li class="nav-item">
          <button class="nav-link" data-bs-toggle="tab" data-bs-target="#saved">Bộ phim đã lưu</button>
        </li>
      </ul>
