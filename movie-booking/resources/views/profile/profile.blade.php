        ...
        <div class="col-md-3">
          ...
          <div class="avatar-card">
            ...
            <div class="avatar-wrapper">
              <img src="{{ $user->avatar ? asset($user->avatar) : '/images/default-avatar.png' }}" class="avatar-image"
                alt="Avatar">
          ...
          <div class="content-card">
            ...
            <ul class="nav nav-tabs custom-tabs mb-4" id="profileTabs" role="tablist">
              <li class="nav-item" role="presentation">
                <a class="nav-link custom-tab active" id="info-tab" data-bs-toggle="tab" href="#info" role="tab"
              ...
              <li class="nav-item" role="presentation">
                <a class="nav-link custom-tab" id="history-tab" data-bs-toggle="tab" href="#history" role="tab"
              ...
              <li class="nav-item" role="presentation">
                <a class="nav-link custom-tab" id="saved-tab" data-bs-toggle="tab" href="#saved" role="tab"
                ...
                @if(isset($bookings) && $bookings->count() > 0)
                  <div style="overflow-x: auto;">
                    @foreach($bookings as $booking)
                      <div
                        style="background: #f8fafc; border-radius: 12px; padding: 1.5rem; margin-bottom: 1rem; border-left: 4px solid {{ $booking->status == 1 ? '#10b981' : '#ef4444' }};">
                        <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 1rem;">
                          ...
                          <span
                            style="padding: 0.25rem 0.75rem; border-radius: 20px; font-size: 0.75rem; font-weight: 600; {{ $booking->status == 1 ? 'background: #d1fae5; color: #065f46;' : 'background: #fee2e2; color: #991b1b;' }}">
                        ...
                        <div
                          ...
                          <div>
                            ...
                            <p style="color: #1e293b; font-weight: 600; margin: 0;">
                              {{ $booking->showtime->room->cinema->name }}</p>
                          </div>
                          <div>
                          ...
                          <div style="margin-bottom: 0.75rem;">
                            ...
                            <div style="display: flex; flex-wrap: wrap; gap: 0.5rem;">
                              @foreach($booking->bookingSeats as $bookingSeat)
                                <span
                                  style="background: #dbeafe; color: #1e40af; padding: 0.25rem 0.75rem; border-radius: 6px; font-size: 0.75rem; font-weight: 600;">
