    ...
    <div class="container py-5">
        ...
        <div class="mb-4">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request('category') == 'review' ? 'active' : '' }}"
                        href="{{ route('posts.index', ['category' => 'review']) }}">
                        <i class="bi bi-film"></i> Review phim
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request('category') == 'news' ? 'active' : '' }}"
                        href="{{ route('posts.index', ['category' => 'news']) }}">
                        <i class="bi bi-newspaper"></i> Tin tức
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request('category') == 'article' ? 'active' : '' }}"
                        href="{{ route('posts.index', ['category' => 'article']) }}">
