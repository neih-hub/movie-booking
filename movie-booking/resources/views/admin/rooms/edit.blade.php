...
@section('page-subtitle', 'Cập nhật thông tin phòng chiếu')
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="total_seats" id="total_seats" class="form-control"
                        value="{{ old('total_seats', $room->total_seats) }}" placeholder="VD: 100" min="1" required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="seats_per_row" id="seats_per_row" class="form-control"
                        value="{{ old('seats_per_row', $room->seats_per_row ?? 10) }}" placeholder="VD: 10" min="1"
                        required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="rows" id="rows" class="form-control"
                        value="{{ old('rows', $room->rows ?? 10) }}" placeholder="VD: 10" min="1" required>
                </div>
            </div>
