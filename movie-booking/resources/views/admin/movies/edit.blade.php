            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" rows="5"
                        placeholder="Nhập mô tả chi tiết về phim...">{{ $movie->description }}</textarea>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <div id="genre-wrapper" class="genre-container">
                        @foreach($genres as $g)
                            <button type="button" class="genre-btn {{ in_array($g, $selectedGenres) ? 'active' : '' }}"
                                data-value="{{ $g }}">
                    ...
                    <input type="hidden" name="genre" id="genreInput"
                        value="{{ is_array($selectedGenres) ? implode(', ', $selectedGenres) : $selectedGenres }}">
                </div>
            </div>
